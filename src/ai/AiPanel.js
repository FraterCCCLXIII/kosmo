...
function createAiPanelElement() {
  ...
  panelEl.style.backgroundColor = 'var(--color-bg-secondary)';
  panelEl.style.borderRadius = 'var(--border-radius-lg) var(--border-radius-lg) 0 0';
  panelEl.style.boxShadow = 'var(--shadow-lg)';
  panelEl.style.display = 'flex';
  panelEl.style.flexDirection = 'column';
  panelEl.style.overflow = 'hidden';
  panelEl.style.transition = 'transform var(--transition-normal)';
  panelEl.style.transform = 'translateY(calc(100% - 50px))';
  panelEl.style.zIndex = 'var(--z-index-fixed)';
  ...
  headerEl.style.borderRadius = 'var(--border-radius-lg) var(--border-radius-lg) 0 0';
  ...
  toggleEl.className = 'ai-panel-toggle';
  toggleEl.innerHTML = '▲';
  toggleEl.style.background = 'none';
  toggleEl.style.border = 'none';
  toggleEl.style.color = 'white';
  toggleEl.style.fontSize = 'var(--font-size-sm)';
  toggleEl.style.cursor = 'pointer';
  toggleEl.setAttribute('aria-label', 'Toggle AI panel');
  ...
  inputEl.style.backgroundColor = 'var(--color-bg-primary)';
  ...
  sendButtonEl.style.fontSize = 'var(--font-size-md)';
...
function togglePanel() {
  ...
  const toggleEl = panelEl.querySelector('.ai-panel-toggle');
  
  if (panelEl.style.transform === 'translateY(0px)') {
    // Collapse panel
    panelEl.style.transform = 'translateY(calc(100% - 50px))';
    toggleEl.innerHTML = '▲';
  } else {
    ...
    // Focus input
    panelEl.querySelector('.ai-panel-input').focus();
  }
}
