...
export async function launch() {
  console.log('Launching voice-memos app...');
  ...
  try {
    ...
    icon.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" viewBox="0 0 16 16"><path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm0 2a5 5 0 0 0-5 5h10a5 5 0 0 0-5-5z"/></svg>';
    ...
    description.textContent = 'Record and manage audio clips';
    ...
    console.error('Error initializing voice-memos app:', error);
    window.getContentElement().innerHTML = `
      <div style="padding: 20px; color: red;">
        <h3>Error initializing voice-memos app</h3>
        <p>${error.message}</p>
        <pre>${error.stack}</pre>
      </div>
    `;
