...
/**
 * Launch the [APP_NAME] app
 */
export async function launch() {
  console.log('Launching [APP_NAME] app...');
  ...
  try {
    ...
    description.textContent = '[APP_DESCRIPTION]';
    ...
    console.error('Error initializing [APP_NAME] app:', error);
    window.getContentElement().innerHTML = `
      <div style="padding: 20px; color: red;">
        <h3>Error initializing [APP_NAME] app</h3>
        <p>${error.message}</p>
        <pre>${error.stack}</pre>
      </div>
    `;
