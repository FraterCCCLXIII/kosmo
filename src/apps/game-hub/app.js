 ...
 * game-hub App
 * 
 * Centralized access to games and game-related features
 */

import { getWindowManager } from '../../ui/WindowManager.js';

/**
 * Launch the game-hub app
 */
export async function launch() {
  console.log('Launching game-hub app...');
  ...
  try {
    ...
    title.textContent = 'Game Hub / Launcher';
    ...
    description.textContent = 'Centralized access to games and game-related features';
    ...
    console.error('Error initializing game-hub app:', error);
    window.getContentElement().innerHTML = `
      <div style="padding: 20px; color: red;">
        <h3>Error initializing game-hub app</h3>
        <p>${error.message}</p>
        <pre>${error.stack}</pre>
      </div>
    `;
